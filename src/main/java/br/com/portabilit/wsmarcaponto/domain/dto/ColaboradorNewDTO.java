...
public class ColaboradorNewDTO implements Serializable {
	...
	@ApiModelProperty(position = 1, required = true, notes = "Deve ser preenchido o nome do Colaborador.")
	@NotBlank(message = "É obrigatório inserir o Nome do Colaborador!")
	private String nome;

	@ApiModelProperty(position = 2, required = true, notes = "Deve ser preenchido o email do Colaborador.")
